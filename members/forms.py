...
class CustomUserCreationForm(UserCreationForm, CustomUserManager):
    ...
    def clean(self, **extra_fields):
        ...
        html_content = render_to_string('email_template.html', {'first_name': self.cleaned_data['first_name'],'last_name': self.cleaned_data['last_name'],'username':self.cleaned_data['flat_Number'], 'password': self.cleaned_data['password1']})
